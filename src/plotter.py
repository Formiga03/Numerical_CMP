...
def plot_graph(lst, sets, filename, title=""):
    ...
    if lst[1][3]:
        ...
        for ii in sets:
            ...
            for jj in ii:
                plt.semilogx(t_data, lst[jj+3], "-x", label="L="+str(lst[2][jj]))
...
def plot_2graphs(lst1, lst2, sets1, sets2, filename, title=""):
        ...
        for ii in range(len(sets1)):
            ...
            for jj1 in range(len(sets1[ii])):
                if lst1[1][3]:
                    ...
                    axs[0].semilogx(t_data1, lst1[sets1[ii][jj1]+3], "-x", label="L="+str(lst1[2][sets1[ii][jj1]]))
                    axs[0].legend()         
                
                if not lst1[1][3]:
                    t_data1 = [x for x in np.arange(lst1[1][0],lst1[1][1],lst1[1][2])]
                    axs[0].plot(t_data1, lst2[sets1[ii][jj1]+3], "-x", label="L="+str(lst1[2][sets1[ii][jj1]]))
                    axs[0].legend()         
            ...
            for jj2 in range(len(sets2[ii])):
                ...
                if lst2[1][3]:
                    ...
                    axs[1].semilogx(t_data2, lst2[sets2[ii][jj2]+3], "-x", label="L="+str(lst2[2][sets2[ii][jj2]]))
                    axs[1].legend()         
                
                if not lst2[1][3]:
                    t_data2 = [x for x in np.arange(lst2[1][0],lst2[1][1],lst2[1][2])]
                    axs[1].plot(t_data2, lst2[sets2[ii][jj2]+3], "-x", label="L="+str(lst2[2][sets2[ii][jj2]]))
                    axs[1].legend()          
